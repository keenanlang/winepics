...
#define	ierror(p)		(((p)->flags&LI_IOERR)!=0)
...
#define LI_IOEOF          0020    /* EOF reached on read */
#define LI_IOERR          0040    /* I/O error from system */
#define LI_IOREAD         0001    /* currently reading */
#define LI_IOWRT          0002    /* currently writing */
#define LI_IORW           0200    /* opened for reading and writing */
