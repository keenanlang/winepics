...
#define __IMSMQQueueInfo_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI get_PrivLevel(long *plPrivLevel) = 0;
    virtual HRESULT WINAPI put_PrivLevel(long lPrivLevel) = 0;
    virtual HRESULT WINAPI get_Journal(long *plJournal) = 0;
    virtual HRESULT WINAPI put_Journal(long lJournal) = 0;
    virtual HRESULT WINAPI get_Quota(long *plQuota) = 0;
    virtual HRESULT WINAPI put_Quota(long lQuota) = 0;
    virtual HRESULT WINAPI get_BasePriority(long *plBasePriority) = 0;
    virtual HRESULT WINAPI put_BasePriority(long lBasePriority) = 0;
    ...
    virtual HRESULT WINAPI get_Authenticate(long *plAuthenticate) = 0;
    virtual HRESULT WINAPI put_Authenticate(long lAuthenticate) = 0;
    virtual HRESULT WINAPI get_JournalQuota(long *plJournalQuota) = 0;
    virtual HRESULT WINAPI put_JournalQuota(long lJournalQuota) = 0;
    ...
    virtual HRESULT WINAPI Open(long Access,long ShareMode,IMSMQQueue **ppq) = 0;
  ...
  typedef struct IMSMQQueueInfoVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_PrivLevel)(IMSMQQueueInfo *This,long *plPrivLevel);
      HRESULT (WINAPI *put_PrivLevel)(IMSMQQueueInfo *This,long lPrivLevel);
      HRESULT (WINAPI *get_Journal)(IMSMQQueueInfo *This,long *plJournal);
      HRESULT (WINAPI *put_Journal)(IMSMQQueueInfo *This,long lJournal);
      HRESULT (WINAPI *get_Quota)(IMSMQQueueInfo *This,long *plQuota);
      HRESULT (WINAPI *put_Quota)(IMSMQQueueInfo *This,long lQuota);
      HRESULT (WINAPI *get_BasePriority)(IMSMQQueueInfo *This,long *plBasePriority);
      HRESULT (WINAPI *put_BasePriority)(IMSMQQueueInfo *This,long lBasePriority);
      ...
      HRESULT (WINAPI *get_Authenticate)(IMSMQQueueInfo *This,long *plAuthenticate);
      HRESULT (WINAPI *put_Authenticate)(IMSMQQueueInfo *This,long lAuthenticate);
      HRESULT (WINAPI *get_JournalQuota)(IMSMQQueueInfo *This,long *plJournalQuota);
      HRESULT (WINAPI *put_JournalQuota)(IMSMQQueueInfo *This,long lJournalQuota);
      ...
      HRESULT (WINAPI *Open)(IMSMQQueueInfo *This,long Access,long ShareMode,IMSMQQueue **ppq);
...
#define IMSMQQueueInfo_Update(This) (This)->lpVtbl->Update(This)
  ...
  HRESULT WINAPI IMSMQQueueInfo_get_PrivLevel_Proxy(IMSMQQueueInfo *This,long *plPrivLevel);
  ...
  HRESULT WINAPI IMSMQQueueInfo_put_PrivLevel_Proxy(IMSMQQueueInfo *This,long lPrivLevel);
  ...
  HRESULT WINAPI IMSMQQueueInfo_get_Journal_Proxy(IMSMQQueueInfo *This,long *plJournal);
  ...
  HRESULT WINAPI IMSMQQueueInfo_put_Journal_Proxy(IMSMQQueueInfo *This,long lJournal);
  ...
  HRESULT WINAPI IMSMQQueueInfo_get_Quota_Proxy(IMSMQQueueInfo *This,long *plQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo_put_Quota_Proxy(IMSMQQueueInfo *This,long lQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo_get_BasePriority_Proxy(IMSMQQueueInfo *This,long *plBasePriority);
  ...
  HRESULT WINAPI IMSMQQueueInfo_put_BasePriority_Proxy(IMSMQQueueInfo *This,long lBasePriority);
  ...
  HRESULT WINAPI IMSMQQueueInfo_get_Authenticate_Proxy(IMSMQQueueInfo *This,long *plAuthenticate);
  ...
  HRESULT WINAPI IMSMQQueueInfo_put_Authenticate_Proxy(IMSMQQueueInfo *This,long lAuthenticate);
  ...
  HRESULT WINAPI IMSMQQueueInfo_get_JournalQuota_Proxy(IMSMQQueueInfo *This,long *plJournalQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo_put_JournalQuota_Proxy(IMSMQQueueInfo *This,long lJournalQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo_Open_Proxy(IMSMQQueueInfo *This,long Access,long ShareMode,IMSMQQueue **ppq);
...
#define __IMSMQQueueInfo2_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI Create(VARIANT *IsTransactional,VARIANT *IsWorldReadable) = 0;
    virtual HRESULT WINAPI Delete(void) = 0;
    virtual HRESULT WINAPI Open(long Access,long ShareMode,IMSMQQueue2 **ppq) = 0;
    virtual HRESULT WINAPI Refresh(void) = 0;
    virtual HRESULT WINAPI Update(void) = 0;
  ...
  typedef struct IMSMQQueueInfo2Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_PrivLevel)(IMSMQQueueInfo2 *This,long *plPrivLevel);
      HRESULT (WINAPI *put_PrivLevel)(IMSMQQueueInfo2 *This,long lPrivLevel);
      HRESULT (WINAPI *get_Journal)(IMSMQQueueInfo2 *This,long *plJournal);
      HRESULT (WINAPI *put_Journal)(IMSMQQueueInfo2 *This,long lJournal);
      HRESULT (WINAPI *get_Quota)(IMSMQQueueInfo2 *This,long *plQuota);
      HRESULT (WINAPI *put_Quota)(IMSMQQueueInfo2 *This,long lQuota);
      HRESULT (WINAPI *get_BasePriority)(IMSMQQueueInfo2 *This,long *plBasePriority);
      HRESULT (WINAPI *put_BasePriority)(IMSMQQueueInfo2 *This,long lBasePriority);
      ...
      HRESULT (WINAPI *get_Authenticate)(IMSMQQueueInfo2 *This,long *plAuthenticate);
      HRESULT (WINAPI *put_Authenticate)(IMSMQQueueInfo2 *This,long lAuthenticate);
      HRESULT (WINAPI *get_JournalQuota)(IMSMQQueueInfo2 *This,long *plJournalQuota);
      HRESULT (WINAPI *put_JournalQuota)(IMSMQQueueInfo2 *This,long lJournalQuota);
      ...
      HRESULT (WINAPI *Open)(IMSMQQueueInfo2 *This,long Access,long ShareMode,IMSMQQueue2 **ppq);
...
#define IMSMQQueueInfo2_put_Security(This,varSecurity) (This)->lpVtbl->put_Security(This,varSecurity)
  ...
  HRESULT WINAPI IMSMQQueueInfo2_get_PrivLevel_Proxy(IMSMQQueueInfo2 *This,long *plPrivLevel);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_put_PrivLevel_Proxy(IMSMQQueueInfo2 *This,long lPrivLevel);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_get_Journal_Proxy(IMSMQQueueInfo2 *This,long *plJournal);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_put_Journal_Proxy(IMSMQQueueInfo2 *This,long lJournal);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_get_Quota_Proxy(IMSMQQueueInfo2 *This,long *plQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_put_Quota_Proxy(IMSMQQueueInfo2 *This,long lQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_get_BasePriority_Proxy(IMSMQQueueInfo2 *This,long *plBasePriority);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_put_BasePriority_Proxy(IMSMQQueueInfo2 *This,long lBasePriority);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_get_Authenticate_Proxy(IMSMQQueueInfo2 *This,long *plAuthenticate);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_put_Authenticate_Proxy(IMSMQQueueInfo2 *This,long lAuthenticate);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_get_JournalQuota_Proxy(IMSMQQueueInfo2 *This,long *plJournalQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_put_JournalQuota_Proxy(IMSMQQueueInfo2 *This,long lJournalQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo2_Open_Proxy(IMSMQQueueInfo2 *This,long Access,long ShareMode,IMSMQQueue2 **ppq);
...
#define __IMSMQQueueInfo3_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI Create(VARIANT *IsTransactional,VARIANT *IsWorldReadable) = 0;
    virtual HRESULT WINAPI Delete(void) = 0;
    virtual HRESULT WINAPI Open(long Access,long ShareMode,IMSMQQueue3 **ppq) = 0;
    virtual HRESULT WINAPI Refresh(void) = 0;
    virtual HRESULT WINAPI Update(void) = 0;
    virtual HRESULT WINAPI get_PathNameDNS(BSTR *pbstrPathNameDNS) = 0;
    virtual HRESULT WINAPI get_Properties(IDispatch **ppcolProperties) = 0;
  ...
  typedef struct IMSMQQueueInfo3Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_PrivLevel)(IMSMQQueueInfo3 *This,long *plPrivLevel);
      HRESULT (WINAPI *put_PrivLevel)(IMSMQQueueInfo3 *This,long lPrivLevel);
      HRESULT (WINAPI *get_Journal)(IMSMQQueueInfo3 *This,long *plJournal);
      HRESULT (WINAPI *put_Journal)(IMSMQQueueInfo3 *This,long lJournal);
      HRESULT (WINAPI *get_Quota)(IMSMQQueueInfo3 *This,long *plQuota);
      HRESULT (WINAPI *put_Quota)(IMSMQQueueInfo3 *This,long lQuota);
      HRESULT (WINAPI *get_BasePriority)(IMSMQQueueInfo3 *This,long *plBasePriority);
      HRESULT (WINAPI *put_BasePriority)(IMSMQQueueInfo3 *This,long lBasePriority);
      ...
      HRESULT (WINAPI *get_Authenticate)(IMSMQQueueInfo3 *This,long *plAuthenticate);
      HRESULT (WINAPI *put_Authenticate)(IMSMQQueueInfo3 *This,long lAuthenticate);
      HRESULT (WINAPI *get_JournalQuota)(IMSMQQueueInfo3 *This,long *plJournalQuota);
      HRESULT (WINAPI *put_JournalQuota)(IMSMQQueueInfo3 *This,long lJournalQuota);
      ...
      HRESULT (WINAPI *Open)(IMSMQQueueInfo3 *This,long Access,long ShareMode,IMSMQQueue3 **ppq);
...
#define IMSMQQueueInfo3_get_ADsPath(This,pbstrADsPath) (This)->lpVtbl->get_ADsPath(This,pbstrADsPath)
  ...
  HRESULT WINAPI IMSMQQueueInfo3_get_PrivLevel_Proxy(IMSMQQueueInfo3 *This,long *plPrivLevel);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_put_PrivLevel_Proxy(IMSMQQueueInfo3 *This,long lPrivLevel);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_get_Journal_Proxy(IMSMQQueueInfo3 *This,long *plJournal);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_put_Journal_Proxy(IMSMQQueueInfo3 *This,long lJournal);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_get_Quota_Proxy(IMSMQQueueInfo3 *This,long *plQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_put_Quota_Proxy(IMSMQQueueInfo3 *This,long lQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_get_BasePriority_Proxy(IMSMQQueueInfo3 *This,long *plBasePriority);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_put_BasePriority_Proxy(IMSMQQueueInfo3 *This,long lBasePriority);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_get_Authenticate_Proxy(IMSMQQueueInfo3 *This,long *plAuthenticate);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_put_Authenticate_Proxy(IMSMQQueueInfo3 *This,long lAuthenticate);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_get_JournalQuota_Proxy(IMSMQQueueInfo3 *This,long *plJournalQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_put_JournalQuota_Proxy(IMSMQQueueInfo3 *This,long lJournalQuota);
  ...
  HRESULT WINAPI IMSMQQueueInfo3_Open_Proxy(IMSMQQueueInfo3 *This,long Access,long ShareMode,IMSMQQueue3 **ppq);
...
#define __IMSMQQueue_INTERFACE_DEFINED__
  ...
  public:
    virtual HRESULT WINAPI get_Access(long *plAccess) = 0;
    virtual HRESULT WINAPI get_ShareMode(long *plShareMode) = 0;
    virtual HRESULT WINAPI get_QueueInfo(IMSMQQueueInfo **ppqinfo) = 0;
    virtual HRESULT WINAPI get_Handle(long *plHandle) = 0;
  ...
  typedef struct IMSMQQueueVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Access)(IMSMQQueue *This,long *plAccess);
      HRESULT (WINAPI *get_ShareMode)(IMSMQQueue *This,long *plShareMode);
      HRESULT (WINAPI *get_QueueInfo)(IMSMQQueue *This,IMSMQQueueInfo **ppqinfo);
      HRESULT (WINAPI *get_Handle)(IMSMQQueue *This,long *plHandle);
...
#define IMSMQQueue_PeekCurrent(This,WantDestinationQueue,WantBody,ReceiveTimeout,ppmsg) (This)->lpVtbl->PeekCurrent(This,WantDestinationQueue,WantBody,ReceiveTimeout,ppmsg)
#endif
#endif
  HRESULT WINAPI IMSMQQueue_get_Access_Proxy(IMSMQQueue *This,long *plAccess);
  ...
  HRESULT WINAPI IMSMQQueue_get_ShareMode_Proxy(IMSMQQueue *This,long *plShareMode);
  ...
  HRESULT WINAPI IMSMQQueue_get_Handle_Proxy(IMSMQQueue *This,long *plHandle);
...
#define __IMSMQQueue2_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQQueue2Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Access)(IMSMQQueue2 *This,long *plAccess);
      HRESULT (WINAPI *get_ShareMode)(IMSMQQueue2 *This,long *plShareMode);
      HRESULT (WINAPI *get_QueueInfo)(IMSMQQueue2 *This,IMSMQQueueInfo2 **ppqinfo);
      HRESULT (WINAPI *get_Handle)(IMSMQQueue2 *This,long *plHandle);
...
#define IMSMQQueue2_get_Properties(This,ppcolProperties) (This)->lpVtbl->get_Properties(This,ppcolProperties)
#endif
#endif
  HRESULT WINAPI IMSMQQueue2_get_Access_Proxy(IMSMQQueue2 *This,long *plAccess);
  ...
  HRESULT WINAPI IMSMQQueue2_get_ShareMode_Proxy(IMSMQQueue2 *This,long *plShareMode);
  ...
  HRESULT WINAPI IMSMQQueue2_get_Handle_Proxy(IMSMQQueue2 *This,long *plHandle);
...
#define __IMSMQMessage_INTERFACE_DEFINED__
  ...
  public:
    virtual HRESULT WINAPI get_Class(long *plClass) = 0;
    virtual HRESULT WINAPI get_PrivLevel(long *plPrivLevel) = 0;
    virtual HRESULT WINAPI put_PrivLevel(long lPrivLevel) = 0;
    virtual HRESULT WINAPI get_AuthLevel(long *plAuthLevel) = 0;
    virtual HRESULT WINAPI put_AuthLevel(long lAuthLevel) = 0;
    virtual HRESULT WINAPI get_IsAuthenticated(Boolean *pisAuthenticated) = 0;
    virtual HRESULT WINAPI get_Delivery(long *plDelivery) = 0;
    virtual HRESULT WINAPI put_Delivery(long lDelivery) = 0;
    virtual HRESULT WINAPI get_Trace(long *plTrace) = 0;
    virtual HRESULT WINAPI put_Trace(long lTrace) = 0;
    virtual HRESULT WINAPI get_Priority(long *plPriority) = 0;
    virtual HRESULT WINAPI put_Priority(long lPriority) = 0;
    virtual HRESULT WINAPI get_Journal(long *plJournal) = 0;
    virtual HRESULT WINAPI put_Journal(long lJournal) = 0;
    ...
    virtual HRESULT WINAPI get_BodyLength(long *pcbBody) = 0;
    ...
    virtual HRESULT WINAPI get_Ack(long *plAck) = 0;
    virtual HRESULT WINAPI put_Ack(long lAck) = 0;
    virtual HRESULT WINAPI get_Label(BSTR *pbstrLabel) = 0;
    virtual HRESULT WINAPI put_Label(BSTR bstrLabel) = 0;
    virtual HRESULT WINAPI get_MaxTimeToReachQueue(long *plMaxTimeToReachQueue) = 0;
    virtual HRESULT WINAPI put_MaxTimeToReachQueue(long lMaxTimeToReachQueue) = 0;
    virtual HRESULT WINAPI get_MaxTimeToReceive(long *plMaxTimeToReceive) = 0;
    virtual HRESULT WINAPI put_MaxTimeToReceive(long lMaxTimeToReceive) = 0;
    virtual HRESULT WINAPI get_HashAlgorithm(long *plHashAlg) = 0;
    virtual HRESULT WINAPI put_HashAlgorithm(long lHashAlg) = 0;
    virtual HRESULT WINAPI get_EncryptAlgorithm(long *plEncryptAlg) = 0;
    virtual HRESULT WINAPI put_EncryptAlgorithm(long lEncryptAlg) = 0;
    ...
    virtual HRESULT WINAPI get_SenderIdType(long *plSenderIdType) = 0;
    virtual HRESULT WINAPI put_SenderIdType(long lSenderIdType) = 0;
  ...
  typedef struct IMSMQMessageVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(IMSMQMessage *This,long *plClass);
      HRESULT (WINAPI *get_PrivLevel)(IMSMQMessage *This,long *plPrivLevel);
      HRESULT (WINAPI *put_PrivLevel)(IMSMQMessage *This,long lPrivLevel);
      HRESULT (WINAPI *get_AuthLevel)(IMSMQMessage *This,long *plAuthLevel);
      HRESULT (WINAPI *put_AuthLevel)(IMSMQMessage *This,long lAuthLevel);
      HRESULT (WINAPI *get_IsAuthenticated)(IMSMQMessage *This,Boolean *pisAuthenticated);
      HRESULT (WINAPI *get_Delivery)(IMSMQMessage *This,long *plDelivery);
      HRESULT (WINAPI *put_Delivery)(IMSMQMessage *This,long lDelivery);
      HRESULT (WINAPI *get_Trace)(IMSMQMessage *This,long *plTrace);
      HRESULT (WINAPI *put_Trace)(IMSMQMessage *This,long lTrace);
      HRESULT (WINAPI *get_Priority)(IMSMQMessage *This,long *plPriority);
      HRESULT (WINAPI *put_Priority)(IMSMQMessage *This,long lPriority);
      HRESULT (WINAPI *get_Journal)(IMSMQMessage *This,long *plJournal);
      HRESULT (WINAPI *put_Journal)(IMSMQMessage *This,long lJournal);
      ...
      HRESULT (WINAPI *get_AppSpecific)(IMSMQMessage *This,long *plAppSpecific);
      HRESULT (WINAPI *put_AppSpecific)(IMSMQMessage *This,long lAppSpecific);
      HRESULT (WINAPI *get_SourceMachineGuid)(IMSMQMessage *This,BSTR *pbstrGuidSrcMachine);
      HRESULT (WINAPI *get_BodyLength)(IMSMQMessage *This,long *pcbBody);
      ...
      HRESULT (WINAPI *get_Ack)(IMSMQMessage *This,long *plAck);
      HRESULT (WINAPI *put_Ack)(IMSMQMessage *This,long lAck);
      HRESULT (WINAPI *get_Label)(IMSMQMessage *This,BSTR *pbstrLabel);
      HRESULT (WINAPI *put_Label)(IMSMQMessage *This,BSTR bstrLabel);
      HRESULT (WINAPI *get_MaxTimeToReachQueue)(IMSMQMessage *This,long *plMaxTimeToReachQueue);
      HRESULT (WINAPI *put_MaxTimeToReachQueue)(IMSMQMessage *This,long lMaxTimeToReachQueue);
      HRESULT (WINAPI *get_MaxTimeToReceive)(IMSMQMessage *This,long *plMaxTimeToReceive);
      HRESULT (WINAPI *put_MaxTimeToReceive)(IMSMQMessage *This,long lMaxTimeToReceive);
      HRESULT (WINAPI *get_HashAlgorithm)(IMSMQMessage *This,long *plHashAlg);
      HRESULT (WINAPI *put_HashAlgorithm)(IMSMQMessage *This,long lHashAlg);
      HRESULT (WINAPI *get_EncryptAlgorithm)(IMSMQMessage *This,long *plEncryptAlg);
      HRESULT (WINAPI *put_EncryptAlgorithm)(IMSMQMessage *This,long lEncryptAlg);
      ...
      HRESULT (WINAPI *get_SenderIdType)(IMSMQMessage *This,long *plSenderIdType);
      HRESULT (WINAPI *put_SenderIdType)(IMSMQMessage *This,long lSenderIdType);
...
#define IMSMQMessage_AttachCurrentSecurityContext(This) (This)->lpVtbl->AttachCurrentSecurityContext(This)
#endif
#endif
  HRESULT WINAPI IMSMQMessage_get_Class_Proxy(IMSMQMessage *This,long *plClass);
  ...
  HRESULT WINAPI IMSMQMessage_get_PrivLevel_Proxy(IMSMQMessage *This,long *plPrivLevel);
  ...
  HRESULT WINAPI IMSMQMessage_put_PrivLevel_Proxy(IMSMQMessage *This,long lPrivLevel);
  ...
  HRESULT WINAPI IMSMQMessage_get_AuthLevel_Proxy(IMSMQMessage *This,long *plAuthLevel);
  ...
  HRESULT WINAPI IMSMQMessage_put_AuthLevel_Proxy(IMSMQMessage *This,long lAuthLevel);
  ...
  HRESULT WINAPI IMSMQMessage_get_Delivery_Proxy(IMSMQMessage *This,long *plDelivery);
  ...
  HRESULT WINAPI IMSMQMessage_put_Delivery_Proxy(IMSMQMessage *This,long lDelivery);
  ...
  HRESULT WINAPI IMSMQMessage_get_Trace_Proxy(IMSMQMessage *This,long *plTrace);
  ...
  HRESULT WINAPI IMSMQMessage_put_Trace_Proxy(IMSMQMessage *This,long lTrace);
  ...
  HRESULT WINAPI IMSMQMessage_get_Priority_Proxy(IMSMQMessage *This,long *plPriority);
  ...
  HRESULT WINAPI IMSMQMessage_put_Priority_Proxy(IMSMQMessage *This,long lPriority);
  ...
  HRESULT WINAPI IMSMQMessage_get_Journal_Proxy(IMSMQMessage *This,long *plJournal);
  ...
  HRESULT WINAPI IMSMQMessage_put_Journal_Proxy(IMSMQMessage *This,long lJournal);
  ...
  HRESULT WINAPI IMSMQMessage_get_AppSpecific_Proxy(IMSMQMessage *This,long *plAppSpecific);
  ...
  HRESULT WINAPI IMSMQMessage_put_AppSpecific_Proxy(IMSMQMessage *This,long lAppSpecific);
  ...
  HRESULT WINAPI IMSMQMessage_get_BodyLength_Proxy(IMSMQMessage *This,long *pcbBody);
  ...
  HRESULT WINAPI IMSMQMessage_get_Ack_Proxy(IMSMQMessage *This,long *plAck);
  ...
  HRESULT WINAPI IMSMQMessage_put_Ack_Proxy(IMSMQMessage *This,long lAck);
  ...
  HRESULT WINAPI IMSMQMessage_get_MaxTimeToReachQueue_Proxy(IMSMQMessage *This,long *plMaxTimeToReachQueue);
  ...
  HRESULT WINAPI IMSMQMessage_put_MaxTimeToReachQueue_Proxy(IMSMQMessage *This,long lMaxTimeToReachQueue);
  ...
  HRESULT WINAPI IMSMQMessage_get_MaxTimeToReceive_Proxy(IMSMQMessage *This,long *plMaxTimeToReceive);
  ...
  HRESULT WINAPI IMSMQMessage_put_MaxTimeToReceive_Proxy(IMSMQMessage *This,long lMaxTimeToReceive);
  ...
  HRESULT WINAPI IMSMQMessage_get_HashAlgorithm_Proxy(IMSMQMessage *This,long *plHashAlg);
  ...
  HRESULT WINAPI IMSMQMessage_put_HashAlgorithm_Proxy(IMSMQMessage *This,long lHashAlg);
  ...
  HRESULT WINAPI IMSMQMessage_get_EncryptAlgorithm_Proxy(IMSMQMessage *This,long *plEncryptAlg);
  ...
  HRESULT WINAPI IMSMQMessage_put_EncryptAlgorithm_Proxy(IMSMQMessage *This,long lEncryptAlg);
  ...
  HRESULT WINAPI IMSMQMessage_get_SenderIdType_Proxy(IMSMQMessage *This,long *plSenderIdType);
  ...
  HRESULT WINAPI IMSMQMessage_put_SenderIdType_Proxy(IMSMQMessage *This,long lSenderIdType);
...
#define __IMSMQTransaction_INTERFACE_DEFINED__
  ...
  public:
    virtual HRESULT WINAPI get_Transaction(long *plTransaction) = 0;
  ...
  typedef struct IMSMQTransactionVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Transaction)(IMSMQTransaction *This,long *plTransaction);
...
#endif
#endif
  HRESULT WINAPI IMSMQTransaction_get_Transaction_Proxy(IMSMQTransaction *This,long *plTransaction);
...
#define __IMSMQMessage2_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI AttachCurrentSecurityContext(void) = 0;
    virtual HRESULT WINAPI get_SenderVersion(long *plSenderVersion) = 0;
    ...
    virtual HRESULT WINAPI get_AuthenticationProviderType(long *plAuthProvType) = 0;
    virtual HRESULT WINAPI put_AuthenticationProviderType(long lAuthProvType) = 0;
    ...
    virtual HRESULT WINAPI get_MsgClass(long *plMsgClass) = 0;
    virtual HRESULT WINAPI put_MsgClass(long lMsgClass) = 0;
    virtual HRESULT WINAPI get_Properties(IDispatch **ppcolProperties) = 0;
  ...
  typedef struct IMSMQMessage2Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(IMSMQMessage2 *This,long *plClass);
      HRESULT (WINAPI *get_PrivLevel)(IMSMQMessage2 *This,long *plPrivLevel);
      HRESULT (WINAPI *put_PrivLevel)(IMSMQMessage2 *This,long lPrivLevel);
      HRESULT (WINAPI *get_AuthLevel)(IMSMQMessage2 *This,long *plAuthLevel);
      HRESULT (WINAPI *put_AuthLevel)(IMSMQMessage2 *This,long lAuthLevel);
      HRESULT (WINAPI *get_IsAuthenticated)(IMSMQMessage2 *This,Boolean *pisAuthenticated);
      HRESULT (WINAPI *get_Delivery)(IMSMQMessage2 *This,long *plDelivery);
      HRESULT (WINAPI *put_Delivery)(IMSMQMessage2 *This,long lDelivery);
      HRESULT (WINAPI *get_Trace)(IMSMQMessage2 *This,long *plTrace);
      HRESULT (WINAPI *put_Trace)(IMSMQMessage2 *This,long lTrace);
      HRESULT (WINAPI *get_Priority)(IMSMQMessage2 *This,long *plPriority);
      HRESULT (WINAPI *put_Priority)(IMSMQMessage2 *This,long lPriority);
      HRESULT (WINAPI *get_Journal)(IMSMQMessage2 *This,long *plJournal);
      HRESULT (WINAPI *put_Journal)(IMSMQMessage2 *This,long lJournal);
      ...
      HRESULT (WINAPI *get_AppSpecific)(IMSMQMessage2 *This,long *plAppSpecific);
      HRESULT (WINAPI *put_AppSpecific)(IMSMQMessage2 *This,long lAppSpecific);
      HRESULT (WINAPI *get_SourceMachineGuid)(IMSMQMessage2 *This,BSTR *pbstrGuidSrcMachine);
      HRESULT (WINAPI *get_BodyLength)(IMSMQMessage2 *This,long *pcbBody);
      ...
      HRESULT (WINAPI *get_Ack)(IMSMQMessage2 *This,long *plAck);
      HRESULT (WINAPI *put_Ack)(IMSMQMessage2 *This,long lAck);
      HRESULT (WINAPI *get_Label)(IMSMQMessage2 *This,BSTR *pbstrLabel);
      HRESULT (WINAPI *put_Label)(IMSMQMessage2 *This,BSTR bstrLabel);
      HRESULT (WINAPI *get_MaxTimeToReachQueue)(IMSMQMessage2 *This,long *plMaxTimeToReachQueue);
      HRESULT (WINAPI *put_MaxTimeToReachQueue)(IMSMQMessage2 *This,long lMaxTimeToReachQueue);
      HRESULT (WINAPI *get_MaxTimeToReceive)(IMSMQMessage2 *This,long *plMaxTimeToReceive);
      HRESULT (WINAPI *put_MaxTimeToReceive)(IMSMQMessage2 *This,long lMaxTimeToReceive);
      HRESULT (WINAPI *get_HashAlgorithm)(IMSMQMessage2 *This,long *plHashAlg);
      HRESULT (WINAPI *put_HashAlgorithm)(IMSMQMessage2 *This,long lHashAlg);
      HRESULT (WINAPI *get_EncryptAlgorithm)(IMSMQMessage2 *This,long *plEncryptAlg);
      HRESULT (WINAPI *put_EncryptAlgorithm)(IMSMQMessage2 *This,long lEncryptAlg);
      ...
      HRESULT (WINAPI *get_SenderIdType)(IMSMQMessage2 *This,long *plSenderIdType);
      HRESULT (WINAPI *put_SenderIdType)(IMSMQMessage2 *This,long lSenderIdType);
      ...
      HRESULT (WINAPI *get_SenderVersion)(IMSMQMessage2 *This,long *plSenderVersion);
      ...
      HRESULT (WINAPI *get_AuthenticationProviderType)(IMSMQMessage2 *This,long *plAuthProvType);
      HRESULT (WINAPI *put_AuthenticationProviderType)(IMSMQMessage2 *This,long lAuthProvType);
      ...
      HRESULT (WINAPI *get_MsgClass)(IMSMQMessage2 *This,long *plMsgClass);
      HRESULT (WINAPI *put_MsgClass)(IMSMQMessage2 *This,long lMsgClass);
...
#define IMSMQMessage2_get_ReceivedAuthenticationLevel(This,psReceivedAuthenticationLevel) (This)->lpVtbl->get_ReceivedAuthenticationLevel(This,psReceivedAuthenticationLevel)
#endif
#endif
  HRESULT WINAPI IMSMQMessage2_get_Class_Proxy(IMSMQMessage2 *This,long *plClass);
  ...
  HRESULT WINAPI IMSMQMessage2_get_PrivLevel_Proxy(IMSMQMessage2 *This,long *plPrivLevel);
  ...
  HRESULT WINAPI IMSMQMessage2_put_PrivLevel_Proxy(IMSMQMessage2 *This,long lPrivLevel);
  ...
  HRESULT WINAPI IMSMQMessage2_get_AuthLevel_Proxy(IMSMQMessage2 *This,long *plAuthLevel);
  ...
  HRESULT WINAPI IMSMQMessage2_put_AuthLevel_Proxy(IMSMQMessage2 *This,long lAuthLevel);
  ...
  HRESULT WINAPI IMSMQMessage2_get_Delivery_Proxy(IMSMQMessage2 *This,long *plDelivery);
  ...
  HRESULT WINAPI IMSMQMessage2_put_Delivery_Proxy(IMSMQMessage2 *This,long lDelivery);
  ...
  HRESULT WINAPI IMSMQMessage2_get_Trace_Proxy(IMSMQMessage2 *This,long *plTrace);
  ...
  HRESULT WINAPI IMSMQMessage2_put_Trace_Proxy(IMSMQMessage2 *This,long lTrace);
  ...
  HRESULT WINAPI IMSMQMessage2_get_Priority_Proxy(IMSMQMessage2 *This,long *plPriority);
  ...
  HRESULT WINAPI IMSMQMessage2_put_Priority_Proxy(IMSMQMessage2 *This,long lPriority);
  ...
  HRESULT WINAPI IMSMQMessage2_get_Journal_Proxy(IMSMQMessage2 *This,long *plJournal);
  ...
  HRESULT WINAPI IMSMQMessage2_put_Journal_Proxy(IMSMQMessage2 *This,long lJournal);
  ...
  HRESULT WINAPI IMSMQMessage2_get_AppSpecific_Proxy(IMSMQMessage2 *This,long *plAppSpecific);
  ...
  HRESULT WINAPI IMSMQMessage2_put_AppSpecific_Proxy(IMSMQMessage2 *This,long lAppSpecific);
  ...
  HRESULT WINAPI IMSMQMessage2_get_BodyLength_Proxy(IMSMQMessage2 *This,long *pcbBody);
  ...
  HRESULT WINAPI IMSMQMessage2_get_Ack_Proxy(IMSMQMessage2 *This,long *plAck);
  ...
  HRESULT WINAPI IMSMQMessage2_put_Ack_Proxy(IMSMQMessage2 *This,long lAck);
  ...
  HRESULT WINAPI IMSMQMessage2_get_MaxTimeToReachQueue_Proxy(IMSMQMessage2 *This,long *plMaxTimeToReachQueue);
  ...
  HRESULT WINAPI IMSMQMessage2_put_MaxTimeToReachQueue_Proxy(IMSMQMessage2 *This,long lMaxTimeToReachQueue);
  ...
  HRESULT WINAPI IMSMQMessage2_get_MaxTimeToReceive_Proxy(IMSMQMessage2 *This,long *plMaxTimeToReceive);
  ...
  HRESULT WINAPI IMSMQMessage2_put_MaxTimeToReceive_Proxy(IMSMQMessage2 *This,long lMaxTimeToReceive);
  ...
  HRESULT WINAPI IMSMQMessage2_get_HashAlgorithm_Proxy(IMSMQMessage2 *This,long *plHashAlg);
  ...
  HRESULT WINAPI IMSMQMessage2_put_HashAlgorithm_Proxy(IMSMQMessage2 *This,long lHashAlg);
  ...
  HRESULT WINAPI IMSMQMessage2_get_EncryptAlgorithm_Proxy(IMSMQMessage2 *This,long *plEncryptAlg);
  ...
  HRESULT WINAPI IMSMQMessage2_put_EncryptAlgorithm_Proxy(IMSMQMessage2 *This,long lEncryptAlg);
  ...
  HRESULT WINAPI IMSMQMessage2_get_SenderIdType_Proxy(IMSMQMessage2 *This,long *plSenderIdType);
  ...
  HRESULT WINAPI IMSMQMessage2_put_SenderIdType_Proxy(IMSMQMessage2 *This,long lSenderIdType);
  ...
  HRESULT WINAPI IMSMQMessage2_get_SenderVersion_Proxy(IMSMQMessage2 *This,long *plSenderVersion);
  ...
  HRESULT WINAPI IMSMQMessage2_get_AuthenticationProviderType_Proxy(IMSMQMessage2 *This,long *plAuthProvType);
  ...
  HRESULT WINAPI IMSMQMessage2_put_AuthenticationProviderType_Proxy(IMSMQMessage2 *This,long lAuthProvType);
  ...
  HRESULT WINAPI IMSMQMessage2_get_MsgClass_Proxy(IMSMQMessage2 *This,long *plMsgClass);
  ...
  HRESULT WINAPI IMSMQMessage2_put_MsgClass_Proxy(IMSMQMessage2 *This,long lMsgClass);
...
#define __IMSMQMessage3_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQMessage3Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(IMSMQMessage3 *This,long *plClass);
      HRESULT (WINAPI *get_PrivLevel)(IMSMQMessage3 *This,long *plPrivLevel);
      HRESULT (WINAPI *put_PrivLevel)(IMSMQMessage3 *This,long lPrivLevel);
      HRESULT (WINAPI *get_AuthLevel)(IMSMQMessage3 *This,long *plAuthLevel);
      HRESULT (WINAPI *put_AuthLevel)(IMSMQMessage3 *This,long lAuthLevel);
      HRESULT (WINAPI *get_IsAuthenticated)(IMSMQMessage3 *This,Boolean *pisAuthenticated);
      HRESULT (WINAPI *get_Delivery)(IMSMQMessage3 *This,long *plDelivery);
      HRESULT (WINAPI *put_Delivery)(IMSMQMessage3 *This,long lDelivery);
      HRESULT (WINAPI *get_Trace)(IMSMQMessage3 *This,long *plTrace);
      HRESULT (WINAPI *put_Trace)(IMSMQMessage3 *This,long lTrace);
      HRESULT (WINAPI *get_Priority)(IMSMQMessage3 *This,long *plPriority);
      HRESULT (WINAPI *put_Priority)(IMSMQMessage3 *This,long lPriority);
      HRESULT (WINAPI *get_Journal)(IMSMQMessage3 *This,long *plJournal);
      HRESULT (WINAPI *put_Journal)(IMSMQMessage3 *This,long lJournal);
      ...
      HRESULT (WINAPI *get_AppSpecific)(IMSMQMessage3 *This,long *plAppSpecific);
      HRESULT (WINAPI *put_AppSpecific)(IMSMQMessage3 *This,long lAppSpecific);
      HRESULT (WINAPI *get_SourceMachineGuid)(IMSMQMessage3 *This,BSTR *pbstrGuidSrcMachine);
      HRESULT (WINAPI *get_BodyLength)(IMSMQMessage3 *This,long *pcbBody);
      ...
      HRESULT (WINAPI *get_Ack)(IMSMQMessage3 *This,long *plAck);
      HRESULT (WINAPI *put_Ack)(IMSMQMessage3 *This,long lAck);
      HRESULT (WINAPI *get_Label)(IMSMQMessage3 *This,BSTR *pbstrLabel);
      HRESULT (WINAPI *put_Label)(IMSMQMessage3 *This,BSTR bstrLabel);
      HRESULT (WINAPI *get_MaxTimeToReachQueue)(IMSMQMessage3 *This,long *plMaxTimeToReachQueue);
      HRESULT (WINAPI *put_MaxTimeToReachQueue)(IMSMQMessage3 *This,long lMaxTimeToReachQueue);
      HRESULT (WINAPI *get_MaxTimeToReceive)(IMSMQMessage3 *This,long *plMaxTimeToReceive);
      HRESULT (WINAPI *put_MaxTimeToReceive)(IMSMQMessage3 *This,long lMaxTimeToReceive);
      HRESULT (WINAPI *get_HashAlgorithm)(IMSMQMessage3 *This,long *plHashAlg);
      HRESULT (WINAPI *put_HashAlgorithm)(IMSMQMessage3 *This,long lHashAlg);
      HRESULT (WINAPI *get_EncryptAlgorithm)(IMSMQMessage3 *This,long *plEncryptAlg);
      HRESULT (WINAPI *put_EncryptAlgorithm)(IMSMQMessage3 *This,long lEncryptAlg);
      ...
      HRESULT (WINAPI *get_SenderIdType)(IMSMQMessage3 *This,long *plSenderIdType);
      HRESULT (WINAPI *put_SenderIdType)(IMSMQMessage3 *This,long lSenderIdType);
      ...
      HRESULT (WINAPI *get_SenderVersion)(IMSMQMessage3 *This,long *plSenderVersion);
      ...
      HRESULT (WINAPI *get_AuthenticationProviderType)(IMSMQMessage3 *This,long *plAuthProvType);
      HRESULT (WINAPI *put_AuthenticationProviderType)(IMSMQMessage3 *This,long lAuthProvType);
      ...
      HRESULT (WINAPI *get_MsgClass)(IMSMQMessage3 *This,long *plMsgClass);
      HRESULT (WINAPI *put_MsgClass)(IMSMQMessage3 *This,long lMsgClass);
...
#define IMSMQMessage3_put_SoapBody(This,bstrSoapBody) (This)->lpVtbl->put_SoapBody(This,bstrSoapBody)
#endif
#endif
  HRESULT WINAPI IMSMQMessage3_get_Class_Proxy(IMSMQMessage3 *This,long *plClass);
  ...
  HRESULT WINAPI IMSMQMessage3_get_PrivLevel_Proxy(IMSMQMessage3 *This,long *plPrivLevel);
  ...
  HRESULT WINAPI IMSMQMessage3_put_PrivLevel_Proxy(IMSMQMessage3 *This,long lPrivLevel);
  ...
  HRESULT WINAPI IMSMQMessage3_get_AuthLevel_Proxy(IMSMQMessage3 *This,long *plAuthLevel);
  ...
  HRESULT WINAPI IMSMQMessage3_put_AuthLevel_Proxy(IMSMQMessage3 *This,long lAuthLevel);
  ...
  HRESULT WINAPI IMSMQMessage3_get_Delivery_Proxy(IMSMQMessage3 *This,long *plDelivery);
  ...
  HRESULT WINAPI IMSMQMessage3_put_Delivery_Proxy(IMSMQMessage3 *This,long lDelivery);
  ...
  HRESULT WINAPI IMSMQMessage3_get_Trace_Proxy(IMSMQMessage3 *This,long *plTrace);
  ...
  HRESULT WINAPI IMSMQMessage3_put_Trace_Proxy(IMSMQMessage3 *This,long lTrace);
  ...
  HRESULT WINAPI IMSMQMessage3_get_Priority_Proxy(IMSMQMessage3 *This,long *plPriority);
  ...
  HRESULT WINAPI IMSMQMessage3_put_Priority_Proxy(IMSMQMessage3 *This,long lPriority);
  ...
  HRESULT WINAPI IMSMQMessage3_get_Journal_Proxy(IMSMQMessage3 *This,long *plJournal);
  ...
  HRESULT WINAPI IMSMQMessage3_put_Journal_Proxy(IMSMQMessage3 *This,long lJournal);
  ...
  HRESULT WINAPI IMSMQMessage3_get_AppSpecific_Proxy(IMSMQMessage3 *This,long *plAppSpecific);
  ...
  HRESULT WINAPI IMSMQMessage3_put_AppSpecific_Proxy(IMSMQMessage3 *This,long lAppSpecific);
  ...
  HRESULT WINAPI IMSMQMessage3_get_BodyLength_Proxy(IMSMQMessage3 *This,long *pcbBody);
  ...
  HRESULT WINAPI IMSMQMessage3_get_Ack_Proxy(IMSMQMessage3 *This,long *plAck);
  ...
  HRESULT WINAPI IMSMQMessage3_put_Ack_Proxy(IMSMQMessage3 *This,long lAck);
  ...
  HRESULT WINAPI IMSMQMessage3_get_MaxTimeToReachQueue_Proxy(IMSMQMessage3 *This,long *plMaxTimeToReachQueue);
  ...
  HRESULT WINAPI IMSMQMessage3_put_MaxTimeToReachQueue_Proxy(IMSMQMessage3 *This,long lMaxTimeToReachQueue);
  ...
  HRESULT WINAPI IMSMQMessage3_get_MaxTimeToReceive_Proxy(IMSMQMessage3 *This,long *plMaxTimeToReceive);
  ...
  HRESULT WINAPI IMSMQMessage3_put_MaxTimeToReceive_Proxy(IMSMQMessage3 *This,long lMaxTimeToReceive);
  ...
  HRESULT WINAPI IMSMQMessage3_get_HashAlgorithm_Proxy(IMSMQMessage3 *This,long *plHashAlg);
  ...
  HRESULT WINAPI IMSMQMessage3_put_HashAlgorithm_Proxy(IMSMQMessage3 *This,long lHashAlg);
  ...
  HRESULT WINAPI IMSMQMessage3_get_EncryptAlgorithm_Proxy(IMSMQMessage3 *This,long *plEncryptAlg);
  ...
  HRESULT WINAPI IMSMQMessage3_put_EncryptAlgorithm_Proxy(IMSMQMessage3 *This,long lEncryptAlg);
  ...
  HRESULT WINAPI IMSMQMessage3_get_SenderIdType_Proxy(IMSMQMessage3 *This,long *plSenderIdType);
  ...
  HRESULT WINAPI IMSMQMessage3_put_SenderIdType_Proxy(IMSMQMessage3 *This,long lSenderIdType);
  ...
  HRESULT WINAPI IMSMQMessage3_get_SenderVersion_Proxy(IMSMQMessage3 *This,long *plSenderVersion);
  ...
  HRESULT WINAPI IMSMQMessage3_get_AuthenticationProviderType_Proxy(IMSMQMessage3 *This,long *plAuthProvType);
  ...
  HRESULT WINAPI IMSMQMessage3_put_AuthenticationProviderType_Proxy(IMSMQMessage3 *This,long lAuthProvType);
  ...
  HRESULT WINAPI IMSMQMessage3_get_MsgClass_Proxy(IMSMQMessage3 *This,long *plMsgClass);
  ...
  HRESULT WINAPI IMSMQMessage3_put_MsgClass_Proxy(IMSMQMessage3 *This,long lMsgClass);
...
#define __IMSMQQueue3_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQQueue3Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Access)(IMSMQQueue3 *This,long *plAccess);
      HRESULT (WINAPI *get_ShareMode)(IMSMQQueue3 *This,long *plShareMode);
      HRESULT (WINAPI *get_QueueInfo)(IMSMQQueue3 *This,IMSMQQueueInfo3 **ppqinfo);
      HRESULT (WINAPI *get_Handle)(IMSMQQueue3 *This,long *plHandle);
...
#define IMSMQQueue3_get_IsOpen2(This,pisOpen) (This)->lpVtbl->get_IsOpen2(This,pisOpen)
#endif
#endif
  HRESULT WINAPI IMSMQQueue3_get_Access_Proxy(IMSMQQueue3 *This,long *plAccess);
  ...
  HRESULT WINAPI IMSMQQueue3_get_ShareMode_Proxy(IMSMQQueue3 *This,long *plShareMode);
  ...
  HRESULT WINAPI IMSMQQueue3_get_Handle_Proxy(IMSMQQueue3 *This,long *plHandle);
...
#define __IMSMQPrivateEvent_INTERFACE_DEFINED__
  ...
  public:
    virtual HRESULT WINAPI get_Hwnd(long *phwnd) = 0;
    virtual HRESULT WINAPI FireArrivedEvent(IMSMQQueue *pq,long msgcursor) = 0;
    virtual HRESULT WINAPI FireArrivedErrorEvent(IMSMQQueue *pq,HRESULT hrStatus,long msgcursor) = 0;
  };
#else
  typedef struct IMSMQPrivateEventVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Hwnd)(IMSMQPrivateEvent *This,long *phwnd);
      HRESULT (WINAPI *FireArrivedEvent)(IMSMQPrivateEvent *This,IMSMQQueue *pq,long msgcursor);
...
#define IMSMQPrivateEvent_FireArrivedErrorEvent(This,pq,hrStatus,msgcursor) (This)->lpVtbl->FireArrivedErrorEvent(This,pq,hrStatus,msgcursor)
#endif
#endif
  HRESULT WINAPI IMSMQPrivateEvent_get_Hwnd_Proxy(IMSMQPrivateEvent *This,long *phwnd);
  ...
  HRESULT WINAPI IMSMQPrivateEvent_FireArrivedEvent_Proxy(IMSMQPrivateEvent *This,IMSMQQueue *pq,long msgcursor);
  ...
  HRESULT WINAPI IMSMQPrivateEvent_FireArrivedErrorEvent_Proxy(IMSMQPrivateEvent *This,IMSMQQueue *pq,HRESULT hrStatus,long msgcursor);
...
#define __IMSMQTransaction2_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQTransaction2Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Transaction)(IMSMQTransaction2 *This,long *plTransaction);
...
#define __IMSMQTransaction3_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQTransaction3Vtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Transaction)(IMSMQTransaction3 *This,long *plTransaction);
...
#define __IMSMQCollection_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQCollectionVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Count)(IMSMQCollection *This,long *pCount);
...
#define IMSMQCollection__NewEnum(This,ppunk) (This)->lpVtbl->_NewEnum(This,ppunk)
  ...
  HRESULT WINAPI IMSMQCollection_get_Count_Proxy(IMSMQCollection *This,long *pCount);
...
#define __IMSMQManagement_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI get_FormatName(BSTR *pbstrFormatName) = 0;
    virtual HRESULT WINAPI get_Machine(BSTR *pbstrMachine) = 0;
    virtual HRESULT WINAPI get_MessageCount(long *plMessageCount) = 0;
    virtual HRESULT WINAPI get_ForeignStatus(long *plForeignStatus) = 0;
    virtual HRESULT WINAPI get_QueueType(long *plQueueType) = 0;
    virtual HRESULT WINAPI get_IsLocal(VARIANT_BOOL *pfIsLocal) = 0;
    virtual HRESULT WINAPI get_TransactionalStatus(long *plTransactionalStatus) = 0;
  ...
  typedef struct IMSMQManagementVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_MessageCount)(IMSMQManagement *This,long *plMessageCount);
      HRESULT (WINAPI *get_ForeignStatus)(IMSMQManagement *This,long *plForeignStatus);
      HRESULT (WINAPI *get_QueueType)(IMSMQManagement *This,long *plQueueType);
      HRESULT (WINAPI *get_IsLocal)(IMSMQManagement *This,VARIANT_BOOL *pfIsLocal);
      HRESULT (WINAPI *get_TransactionalStatus)(IMSMQManagement *This,long *plTransactionalStatus);
...
#define IMSMQManagement_get_BytesInQueue(This,pvBytesInQueue) (This)->lpVtbl->get_BytesInQueue(This,pvBytesInQueue)
  ...
  HRESULT WINAPI IMSMQManagement_get_MessageCount_Proxy(IMSMQManagement *This,long *plMessageCount);
  ...
  HRESULT WINAPI IMSMQManagement_get_ForeignStatus_Proxy(IMSMQManagement *This,long *plForeignStatus);
  ...
  HRESULT WINAPI IMSMQManagement_get_QueueType_Proxy(IMSMQManagement *This,long *plQueueType);
  ...
  HRESULT WINAPI IMSMQManagement_get_TransactionalStatus_Proxy(IMSMQManagement *This,long *plTransactionalStatus);
...
#define __IMSMQOutgoingQueueManagement_INTERFACE_DEFINED__
  ...
  typedef struct IMSMQOutgoingQueueManagementVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_MessageCount)(IMSMQOutgoingQueueManagement *This,long *plMessageCount);
      HRESULT (WINAPI *get_ForeignStatus)(IMSMQOutgoingQueueManagement *This,long *plForeignStatus);
      HRESULT (WINAPI *get_QueueType)(IMSMQOutgoingQueueManagement *This,long *plQueueType);
      HRESULT (WINAPI *get_IsLocal)(IMSMQOutgoingQueueManagement *This,VARIANT_BOOL *pfIsLocal);
      HRESULT (WINAPI *get_TransactionalStatus)(IMSMQOutgoingQueueManagement *This,long *plTransactionalStatus);
      HRESULT (WINAPI *get_BytesInQueue)(IMSMQOutgoingQueueManagement *This,VARIANT *pvBytesInQueue);
      HRESULT (WINAPI *get_State)(IMSMQOutgoingQueueManagement *This,long *plState);
...
#endif
#endif
  HRESULT WINAPI IMSMQOutgoingQueueManagement_get_State_Proxy(IMSMQOutgoingQueueManagement *This,long *plState);
...
#define __IMSMQQueueManagement_INTERFACE_DEFINED__
  ...
  public:
    virtual HRESULT WINAPI get_JournalMessageCount(long *plJournalMessageCount) = 0;
  ...
  typedef struct IMSMQQueueManagementVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_MessageCount)(IMSMQQueueManagement *This,long *plMessageCount);
      HRESULT (WINAPI *get_ForeignStatus)(IMSMQQueueManagement *This,long *plForeignStatus);
      HRESULT (WINAPI *get_QueueType)(IMSMQQueueManagement *This,long *plQueueType);
      HRESULT (WINAPI *get_IsLocal)(IMSMQQueueManagement *This,VARIANT_BOOL *pfIsLocal);
      HRESULT (WINAPI *get_TransactionalStatus)(IMSMQQueueManagement *This,long *plTransactionalStatus);
      HRESULT (WINAPI *get_BytesInQueue)(IMSMQQueueManagement *This,VARIANT *pvBytesInQueue);
      HRESULT (WINAPI *get_JournalMessageCount)(IMSMQQueueManagement *This,long *plJournalMessageCount);
...
#endif
#endif
  HRESULT WINAPI IMSMQQueueManagement_get_JournalMessageCount_Proxy(IMSMQQueueManagement *This,long *plJournalMessageCount);
